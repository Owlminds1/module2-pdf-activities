  ...
  return (
    <div className="min-h-screen bg-white p-5">
      ...
      <div className="grid grid-cols-12 rounded-lg overflow-hidden">
        ...
        >
          <Image src="/images/mirror_img.jpg" fill alt=" mirror image" />
          <Controller
            name="first"
            control={control}
            render={({ field }) => (
          ...
          <button className=" mirror_btn  absolute text-white  text-xl  bg-red-500  px-10 py-2  bottom-[80px] left-[42%] rounded-[20px]   placeholder:text-center placeholder:text-slate-600 focus:border-2 hover:bg-red-600 ">
            submit
          </button>
        </form>
